...
SMODS.Consumable:take_ownership('wheel_of_fortune', {
    ...
    loc_txt = {
        text={
            "{C:green}#1# in #2#{} chance to add or upgrade",
            "{C:dark_edition}Foil{} -> {C:dark_edition}Holographic{} -> {C:dark_edition}Polychrome{} edition",
            "to a random {C:attention}Joker. ",
            "Upgrade only happen when all jokers had edition, ",
            "and when all jokers are {C:dark_edition}Polychrome{} ",
            "upgrade random joker {C:dark_edition}Negative{}",
        }
    },
